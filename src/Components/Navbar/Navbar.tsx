            ...
            {navLinks.map((link) => {
              ...
              return (
                <NavLink
                  ...
                  className={({ isActive }) => {
                    if (isActive) {
                      return "px-3 py-2 rounded-md font-bold text-blue-600 bg-gray-100 dark:bg-gray-700";
                    }

                    if (isWishlist && hasWishlistItems) {
                      return "px-3 py-2 rounded-md font-bold text-red-600";
                    }

                    return "px-3 py-2 rounded-md font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700";
                  }}
                >
