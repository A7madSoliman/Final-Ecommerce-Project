    ...
    <>
      <div className="p-2 relative rounded-md overflow-hidden group cursor-pointer bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 transition-colors duration-300 hover:shadow-lg">
        ...
        <div className="relative rounded-md overflow-hidden">
          <img
            src="https://ecommerce.routemisr.com/Route-Academy-products/1680403397482-2.jpeg"
            alt=""
        ...
        <div className="mt-4">
          ...
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-200 mt-1 line-clamp-2 ">
            productName
          </h2>
        </div>
